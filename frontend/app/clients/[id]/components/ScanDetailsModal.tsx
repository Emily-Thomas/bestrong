                ...
                {(() => {
                  ...
                  return weight ? (
                    <div className="border rounded-lg p-3">
                      ...
                      <div className="text-lg font-semibold">{weight} lbs</div>
                    </div>
                  ) : null;
                })()}
                {(() => {
                  ...
                  return smm ? (
                    <div className="border rounded-lg p-3">
                      ...
                      <div className="text-lg font-semibold">{smm} lbs</div>
                    </div>
                  ) : null;
                })()}
                {(() => {
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this InBody scan? This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
