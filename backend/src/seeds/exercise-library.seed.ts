...
/**
 * Idempotent: inserts default catalog exercises; skips rows that already exist (by name).
 * Safe to run on every deploy.
 */
export async function seedExerciseLibraryExercises(): Promise<{
  inserted: number;
  skipped: number;
}> {
  ...
  try {
    ...
    console.log(
      `\n✨ Exercise library seeding complete! (${inserted} inserted, ${skipped} skipped)`
    );
